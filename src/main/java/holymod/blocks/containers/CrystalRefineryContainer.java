package holymod.blocks.containers;
 ...
 */
public class CrystalRefineryContainer extends Container {

	// Stores a reference to the tile entity instance for later use
	private TileEntityCrystalRefinery tileEntityInventoryBasic;
	...
	private final int HOTBAR_SLOT_COUNT = 1;
	...
	public CrystalRefineryContainer(InventoryPlayer invPlayer, TileEntityCrystalRefinery tileEntityInventoryBasic) {
